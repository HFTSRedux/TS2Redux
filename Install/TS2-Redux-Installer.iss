...
SelectDirDesc=This setup wizard will try to find your Homefront game folder automatically for you. If the box below is blank or if you want to change the install path, please click the Browse button and select your Homefront game folder.